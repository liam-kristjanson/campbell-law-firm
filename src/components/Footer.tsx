            ...
            <Row className="p-3">
                <Col lg={3} md={4}>
                    ...
                    <ul style={myStyle} className="d-flex flex-column align-items-start ps-0">
                        ...
                        <li> <Icon path={mdiEmailFastOutline} size={1.3}/> c@campbol.ca</li> 
                        <li><Icon path={mdiMapMarkerRadiusOutline} size={1.3} /> 4000 Middle of Nowhere avenue, R7A5Y9, Winnipeg, MB, Canada.</li>
                    </ul>
                </Col>
                ...
                <h5>Areas of Practice</h5>
                    ...
                    <ul className="d-flex flex-column gap-3 fw-bold text-decoration-underline">
                        <li role="button">Real Estate Law</li>
                        <li role="button">Family Law</li>
                        <li role="button">Immigration Law</li>
                    </ul>
                ...
                <Col lg={3} md={12}>
                    ...
                    <hr />
                    <div className=" d-flex justify-content-center"> {'\u00A9'} CAMPBELL LAW OFFICE. All Rights Reserved.</div>
            </Row>
        {/* </Container> */}
    </footer>
)
